...
#   -------------------------------------------------------------------------------------------------
    ...
    TEMPLATE += '<tr class="blanco"><td class="negro">Auteur du modèle:</td><td>{{udp__Auteurmodele}}</td></tr>'
    TEMPLATE += '<tr class="azul"><td class="negro">Version du modèle: </td><td class="desc">{{udp__Version}}</td></tr>'
    TEMPLATE += '<tr class="blanco"><td class="negro">Description: </td><td class="desc">{{udp__Descriptionmodele}}</td></tr>'
    
    TEMPLATE += '<tr class="azul"><td class="negro">Acteur principal: </td><td class="desc">{{udp__ActeurPrincipal}}</td></tr>'
    TEMPLATE += '<tr class="blanco"><td class="negro">Autres acteurs: </td><td class="desc">{{udp__AutresActeurs}}</td></tr>'
    TEMPLATE += '<tr class="azul"><td class="negro">Intrants declencheurs: </td><td class="desc">{{udp__IntrantsDeclencheurs}}</td></tr>'
    TEMPLATE += '</table>'
