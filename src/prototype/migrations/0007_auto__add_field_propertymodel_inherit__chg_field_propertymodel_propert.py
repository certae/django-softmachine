...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropertyModel.inherit'
        db.add_column('prototype_propertymodel', 'inherit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'PropertyModel.propertyDom'
        db.alter_column('prototype_propertymodel', 'propertyDom_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prototype.PropertyDom'], null=True, on_delete=models.SET_NULL))
        # Adding field 'PropertyDom.inherit'
        db.add_column('prototype_propertydom', 'inherit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Property.propertyModel'
        db.alter_column('prototype_property', 'propertyModel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prototype.PropertyModel'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting field 'PropertyModel.inherit'
        db.delete_column('prototype_propertymodel', 'inherit')


        # Changing field 'PropertyModel.propertyDom'
        db.alter_column('prototype_propertymodel', 'propertyDom_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prototype.PropertyDom'], null=True))
        # Deleting field 'PropertyDom.inherit'
        db.delete_column('prototype_propertydom', 'inherit')


        # Changing field 'Property.propertyModel'
        db.alter_column('prototype_property', 'propertyModel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prototype.PropertyModel'], null=True))
