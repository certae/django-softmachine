...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('prototype_propertyequivalence', (
            ...
            ('sourceProperty', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sourcePrp', null=True, to=orm['prototype.PropertyDom'])),
            ('targetProperty', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='targetPrp', null=True, to=orm['prototype.PropertyDom'])),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('prototype', ['PropertyEquivalence'])

        # Adding unique constraint on 'PropertyEquivalence', fields ['sourceProperty', 'targetProperty']
        db.create_unique('prototype_propertyequivalence', ['sourceProperty_id', 'targetProperty_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PropertyEquivalence', fields ['sourceProperty', 'targetProperty']
        db.delete_unique('prototype_propertyequivalence', ['sourceProperty_id', 'targetProperty_id'])
    ...
    models = {
        ...
        'prototype.propertyequivalence': {
            'Meta': {'unique_together': "(('sourceProperty', 'targetProperty'),)", 'object_name': 'PropertyEquivalence'},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'smCreatedBy': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
            'smCreatedOn': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
