...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('prototype_project', (
            ...
            ('dbEngine', self.gf('django.db.models.fields.CharField')(default='sqlite3', max_length=20, null=True, blank=True)),
            ('dbName', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('dbUser', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('dbPassword', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('dbHost', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('dbPort', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 25, 11, 24, 51, 827000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 25, 11, 24, 51, 827000)'}),
        ...
        'prototype.relationship': {
            ...
            'refEntity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'refEntity_set'", 'to': "orm['prototype.Entity']"}),
