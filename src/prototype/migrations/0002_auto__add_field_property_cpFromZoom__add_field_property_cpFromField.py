...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('prototype_property', 'cpFromZoom', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Property.cpFromField'
        db.add_column('prototype_property', 'cpFromField', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 13, 14, 15, 5, 243000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 13, 14, 15, 5, 243000)'}),
