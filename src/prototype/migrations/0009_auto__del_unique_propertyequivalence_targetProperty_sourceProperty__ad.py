...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'PropertyEquivalence', fields ['targetProperty', 'sourceProperty']
        db.delete_unique('prototype_propertyequivalence', ['targetProperty_id', 'sourceProperty_id'])

        # Adding unique constraint on 'PropertyEquivalence', fields ['targetProperty', 'smOwningTeam', 'sourceProperty']
        db.create_unique('prototype_propertyequivalence', ['targetProperty_id', 'smOwningTeam_id', 'sourceProperty_id'])

        # Adding M2M table for field equivalences on 'Domain'
        db.create_table('prototype_domain_equivalences', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_domain', models.ForeignKey(orm['prototype.domain'], null=False)),
            ('to_domain', models.ForeignKey(orm['prototype.domain'], null=False))
        ))
        db.create_unique('prototype_domain_equivalences', ['from_domain_id', 'to_domain_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PropertyEquivalence', fields ['targetProperty', 'smOwningTeam', 'sourceProperty']
        db.delete_unique('prototype_propertyequivalence', ['targetProperty_id', 'smOwningTeam_id', 'sourceProperty_id'])

        # Adding unique constraint on 'PropertyEquivalence', fields ['targetProperty', 'sourceProperty']
        db.create_unique('prototype_propertyequivalence', ['targetProperty_id', 'sourceProperty_id'])

        # Removing M2M table for field equivalences on 'Domain'
        db.delete_table('prototype_domain_equivalences')
    ...
    models = {
        ...
        'prototype.domain': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'equivalences': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['prototype.Domain']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'smCreatedBy': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
            'smCreatedOn': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            'smModifiedBy': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
