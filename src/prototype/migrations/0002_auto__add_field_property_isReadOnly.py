...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Property.isReadOnly'
        db.add_column('prototype_property', 'isReadOnly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Property.isReadOnly'
        db.delete_column('prototype_property', 'isReadOnly')
