...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EntityMap'
        db.create_table('protoLib_entitymap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('appName', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('modelName', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('fieldLevelSecurity', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('protoLib', ['EntityMap'])

        # Adding unique constraint on 'EntityMap', fields ['appName', 'modelName']
        db.create_unique('protoLib_entitymap', ['appName', 'modelName'])

        # Adding model 'FieldMap'
        db.create_table('protoLib_fieldmap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['protoLib.EntityMap'])),
            ('fieldName', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('canRead', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('canIns', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('canUpd', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('protoLib', ['FieldMap'])

        # Adding unique constraint on 'FieldMap', fields ['entity', 'fieldName']
        db.create_unique('protoLib_fieldmap', ['entity_id', 'fieldName'])
        ...
        # Adding model 'PtFunction'
        db.create_table('protoLib_ptfunction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
            ('modelName', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('arguments', self.gf('django.db.models.fields.CharField')(max_length=400)),
            ('functionBody', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('tag', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('protoLib', ['PtFunction'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'FieldMap', fields ['entity', 'fieldName']
        db.delete_unique('protoLib_fieldmap', ['entity_id', 'fieldName'])

        # Removing unique constraint on 'EntityMap', fields ['appName', 'modelName']
        db.delete_unique('protoLib_entitymap', ['appName', 'modelName'])
        ...
        # Deleting model 'EntityMap'
        db.delete_table('protoLib_entitymap')

        # Deleting model 'FieldMap'
        db.delete_table('protoLib_fieldmap')
        ...
        # Deleting model 'PtFunction'
        db.delete_table('protoLib_ptfunction')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 25, 14, 46, 54, 836000)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 25, 14, 46, 54, 836000)'}),
        ...
        'protoLib.ptfunction': {
            'Meta': {'object_name': 'PtFunction'},
            'arguments': ('django.db.models.fields.CharField', [], {'max_length': '400'}),
            'code': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'functionBody': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modelName': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
