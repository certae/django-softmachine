 ...
 */
Ext.define('ProtoUL.ux.Json', {
    extend: 'ProtoUL.ux.JUtil',
    ...
    */
    ...
    setJsonValue : function(cfg,key,value){
      ...
      //Check if root is a array with more then one element, if so skip
       ...
       var myEncoder = Ext.create('ProtoUL.ux.Json', {jsonId : this.jsonId, nocache : nocache,evalException : false});
...
JSON = Ext.create('ProtoUL.ux.Json', {
   jsonId:'__JSON__',
   licenseText :'/* This file is created or modified by ProtoUL.ux.Json */'
