 ...
 * @type component
 */
Ext.define('ProtoUL.proto.JsonPanel', {
    extend: 'Ext.panel.Panel',
    alias : 'widget.jsonpanel',
    ...
    initComponent: function () {
        ...
        this.json = Ext.create('ProtoUL.ux.Json', {
    ...
    apply: function (cfg, callback) {
        ...
        try {
            ...
            if (this.json.fireEvent('error', 'failedjsonload', e) && this.fireEvent('failedjsonload', cfg, e)) Ext.Msg.alert('Failure', 'Failed to decode load Json:' + e.message)
            return false;
        }
    }
