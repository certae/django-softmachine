...
Ext.define('ProtoUL.UI.MDSetFiltersController', {
    ...
    getCustomOptsBar: function() {
        ...
        var myFilters = [], nFiltre, vDet, tmpF1, pFilters, __MasterDetail = this.__MasterDetail, tmpFilters = this.myMeta.gridSets.filtersSet.concat(this.myMeta.custom.filtersSet);
