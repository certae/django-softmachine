...
Split configuration is used to avoid sending sensitive data to GitHub. This configuration is based on DEBUG variable. If debug is enabled the System is going to load â€œsettings_development.pyâ€ otherwise it will import â€œsettings_production.pyâ€.
```python
if DEBUG :
